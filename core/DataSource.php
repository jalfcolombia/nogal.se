...
class DataSource
{
   ...
   * <b>driver</b> Driver a usar para la conexión a la base de datos. Ejemplo pgsql, mysql<br>
   ...
   * @param \NogalSE\class_object $class_object Clase del objeto a usar para dar respuesta de ese tipo de objeto.
